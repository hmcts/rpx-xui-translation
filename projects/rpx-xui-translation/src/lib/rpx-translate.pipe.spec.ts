  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: ChangeDetectorRef, useValue: jasmine.createSpyObj('ChangeDetectorRef', ['markForCheck', 'detach', 'detectChanges', 'checkNoChanges', 'reattach']) }
      ]
    });

    pipe = TestBed.inject(RpxTranslatePipe);
  });
